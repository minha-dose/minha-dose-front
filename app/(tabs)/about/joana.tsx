...
export default function Joana() {
    return (
        <ScrollView contentContainerStyle={globalStyles.aboutContainer}>
            <PhotoCircle imageSource={require('@/assets/images/devs/joana.jpg')} size={200}></PhotoCircle>
            <AboutComponent>
            ...
            <View style={globalStyles.connect}>
                <Link href="https://www.linkedin.com/in/joana-falc%C3%A3o-05990a287/" target="_blank">
                    <AntDesign name="linkedin-square" size={24} color="#083474" />
                </Link>
                <Link href="mailto:jmanoelafs@gmail.com" target="_blank">
                    <MaterialCommunityIcons name="email" size={24} color="#083474"  />
                </Link>
                <Link href="https://github.com/joanafalcaos" target="_blank">
